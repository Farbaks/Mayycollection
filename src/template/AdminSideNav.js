...
function AdminSideNav() {
    ...
    <div className="admin-sidebar" id="smenucontent">
        <div className="fullwidth">
            ...
            <a href="/admin/custom-orders" className="admin-sidebar-link">
                <div className="admin-sidebar-link-image">
            ...
            <a href="/admin/coupons" className="admin-sidebar-link">
                <div className="admin-sidebar-link-image">
                    <img src={process.env.PUBLIC_URL+'/images/admin-report.svg'} alt="logo" />
                </div>
                <p>Coupons</p>
        ...
        <div className="fullwidth">
            ...
            <a href="/admin/account" className="admin-sidebar-link">
                <div className="admin-sidebar-link-image">
